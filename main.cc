...
int main(int nargs, char **args)
{
	...
	case 0:
		...
		break;
	case 1:
		indexing_of_qalsh_plus(n, d, B, kd_leaf_size, L, M, p, zeta, ratio,
			data_set, data_folder, output_folder);
		break;
	case 2:
		knn_of_qalsh_plus(qn, d, query_set, truth_set, data_folder,
			output_folder);
		break;
	case 3:
		indexing_of_qalsh(n, d, B, p, zeta, ratio, data_set, data_folder, 
			output_folder);
		break;
	case 4:
		knn_of_qalsh(qn, d, query_set, truth_set, data_folder,
			output_folder);
		break;
	case 5:
